...
class App extends Component {
  ...
  toggleMenuHandler = () => {
    if(!this.state.mobileMenuActive) {
      this.setState({
        navMenuClass: "mobile-menu mobile-menu--open",
        line1Class: "mobile-nav-button__line mobile-nav-button__line--1",
        line2Class: "mobile-nav-button__line mobile-nav-button__line--2",
        line3Class: "mobile-nav-button__line mobile-nav-button__line--3"
      });
    } else {
      this.setState({
        navMenuClass: "mobile-menu",
